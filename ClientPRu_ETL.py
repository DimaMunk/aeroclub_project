...
for row in sheet.iterrows():
    ...
    if val_customer == 'Client P': cubeSelect = 'clientpru'
...
#----------------------------------------
    ...
    id_destination = id.detectid('DestinationRu','Destination_name',val_dest, cursor, connection)

    id_region = id.detectid('RegionRu','Region_name',val_region, cursor, connection)

    id_route = id.detectid('Route','Route_name',val_route, cursor, connection)

    id_state = id.detectid('StateRu','State_name',val_state, cursor, connection)
